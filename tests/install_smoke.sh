...
cmp "$project_dir/stickymd" "$x11_home/.local/bin/stickymd"
cmp "$project_dir/simple-sticky" \
    "$x11_home/.local/lib/stickymd/simple-sticky"
cmp "$project_dir/gnome-shell-extension/stickymd@local/extension.js" \
    "$x11_home/.local/share/gnome-shell/extensions/stickymd@local/extension.js"
test -f "$x11_home/.config/autostart/simple-sticky.desktop"

wayland_home="$test_root/wayland-home"
run_install "$wayland_home" wayland 50
cmp "$project_dir/gnome-shell-extension/stickymd@local/extension-modern.js" \
    "$wayland_home/.local/share/gnome-shell/extensions/stickymd@local/extension.js"
cmp "$project_dir/gnome-shell-extension/stickymd@local/metadata-modern.json" \
...
test ! -e "$wayland_home/.config/autostart/simple-sticky.desktop"
HOME="$wayland_home" \
...
test ! -e "$wayland_home/.local/lib/stickymd/simple-sticky"
